...
class Readouts(nn.ModuleDict):
    ...
    def forward(self, inputs: torch.Tensor, mouse_id: str, neuron_ids: torch.Tensor = None, neuron_id_tokenizer: t.Any = None, shifts: torch.Tensor = None):
        return self[mouse_id](inputs, neuron_ids=neuron_ids, neuron_id_tokenizer=neuron_id_tokenizer, shifts=shifts)
