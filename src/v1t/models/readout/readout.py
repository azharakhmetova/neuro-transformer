...
class Readouts(nn.ModuleDict):
    ...
    def forward(self, inputs: torch.Tensor, mouse_id: str, neuron_queries: torch.Tensor = None, shifts: torch.Tensor = None):
        return self[mouse_id](inputs, neuron_queries=neuron_queries, shifts=shifts)
